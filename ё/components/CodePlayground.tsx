...
export function CodePlayground({
  ...
  // Enhanced TypeScript code evaluation with better error handling
  const evaluateTypeScriptCode = (code: string): string => {
    try {
      ...
      // Create a safe execution environment with more features
      const func = new Function(`
        ...
        // Add some helpful functions for space-themed examples
        const launchRocket = (name) => \`🚀 \${name} launched successfully!\`;
        const checkFuel = (level) => level > 50 ? "✅ Fuel OK" : "⚠️ Low fuel";
        const calculateDistance = (speed, time) => speed * time;
