...
export function CodePlayground({
  ...
  const runCode = () => {
    ...
    try {
      ...
      // More flexible comparison - check if expected output is contained in result
      const correct = result.trim().includes(expectedOutput.trim()) || 
                     expectedOutput.trim().includes(result.trim()) ||
  ...
  // Enhanced TypeScript code evaluation with proper output capture
